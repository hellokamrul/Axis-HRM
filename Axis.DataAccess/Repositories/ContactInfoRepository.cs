...
{
    public class ContactInfoRepository : BaseRepository<ContactInfo, string>, IContactInfoRepository
    {
        private readonly IAxisDbContext _context;
        public ContactInfoRepository(IAxisDbContext context) : base((DbContext)(context))
        {
            _context = context;
        }
    }  

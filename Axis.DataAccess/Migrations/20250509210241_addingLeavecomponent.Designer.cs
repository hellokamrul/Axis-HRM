...
namespace Axis.DataAccess.Migrations
{
    ...
    [Migration("20250509210241_addingLeavecomponent")]
    partial class addingLeavecomponent
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Axis.Core.Models.Leave_Holiday.LeaveComponent", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");

                    b.Property<int?>("AllocateOnDay")
                        .HasColumnType("integer")
                        .HasColumnName("allocateonday");
                    ...
                    b.Property<bool?>("AllowOverAllocation")
                        .HasColumnType("boolean")
                        .HasColumnName("allowoverallocation");

                    b.Property<int?>("ApplicationAfterWorkingDays")
                        .HasColumnType("integer")
                        .HasColumnName("applicationafterworkingdays");
                    ...
                    b.Property<string>("EarningComponentId")
                        .HasColumnType("text")
                        .HasColumnName("earningcomponentid");

                    b.Property<int?>("ExpiryInDays")
                        .HasColumnType("integer")
                        .HasColumnName("expiryindays");

                    b.Property<decimal?>("FractionOfDailySalary")
                        .HasColumnType("numeric")
                        .HasColumnName("fractionofdailysalary");

                    b.Property<int?>("Frequency")
                        .HasColumnType("integer")
                        .HasColumnName("frequency");

                    b.Property<bool?>("IncludeHolidaysWithinLeaves")
                        .HasColumnType("boolean")
                        .HasColumnName("includeholidayswithinleaves");
                    ...
                    b.Property<bool?>("IsCompensatory")
                        .HasColumnType("boolean")
                        .HasColumnName("iscompensatory");

                    b.Property<bool?>("IsEarnedLeave")
                        .HasColumnType("boolean")
                        .HasColumnName("isearnedleave");

                    b.Property<bool?>("IsEncashment")
                        .HasColumnType("boolean")
                        .HasColumnName("isencashment");
                    ...
                    b.Property<bool?>("IsPartiallyPaid")
                        .HasColumnType("boolean")
                        .HasColumnName("ispartiallypaid");

                    b.Property<bool?>("IsWithoutPay")
                        .HasColumnType("boolean")
                        .HasColumnName("iswithoutpay");

                    b.Property<int?>("MaxCarryForwardedLeaves")
                        .HasColumnType("integer")
                        .HasColumnName("maxcarryforwardedleaves");

                    b.Property<int?>("MaxEncashableLeaves")
                        .HasColumnType("integer")
                        .HasColumnName("maxencashableleaves");

                    b.Property<decimal?>("MaximumAllocationPerPeriod")
                        .HasColumnType("numeric")
                        .HasColumnName("maximumallocationperperiod");

                    b.Property<int?>("MaximumConsecutiveLeaves")
                        .HasColumnType("integer")
                        .HasColumnName("maximumconsecutiveleaves");
                    ...
                    b.Property<int?>("NonEncashableLeaves")
                        .HasColumnType("integer")
                        .HasColumnName("nonencashableleaves");

                    b.Property<double?>("RoundingRule")
                        .HasColumnType("double precision")
                        .HasColumnName("roundingrule");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_leavecomponents");

                    b.HasIndex("ComId")
                        .HasDatabaseName("ix_leavecomponents_comid");

                    b.ToTable("leavecomponents", (string)null);
                });
            ...
            modelBuilder.Entity("Axis.Core.Models.Leave_Holiday.LeaveComponent", b =>
                {
                    b.HasOne("Axis.Core.Models.Company", "Company")
                        .WithMany()
                        .HasForeignKey("ComId")
                        .HasConstraintName("fk_leavecomponents_companies_comid");
